...
export function Badge({ variant, label }: { variant: Variant; label: string }) {
  ...
  return (
    <span style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '3px 10px', borderRadius: '20px', background: s.bg, fontSize: '12px', fontWeight: 600, color: s.color }}>
